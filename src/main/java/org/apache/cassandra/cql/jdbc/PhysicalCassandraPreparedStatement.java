...
public class PhysicalCassandraPreparedStatement extends PhysicalCassandraStatement implements CassandraPreparedStatement
{
    private static final Logger LOG = LoggerFactory.getLogger(PhysicalCassandraPreparedStatement.class);
    ...
    PhysicalCassandraPreparedStatement(PhysicalCassandraConnection con, String cql, CqlPreparedResult result)
    {
        super(con, cql);
