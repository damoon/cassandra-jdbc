 ...
 */
public class PhysicalCassandraConnection extends AbstractConnection implements CassandraConnection
{

    private static final Logger logger = LoggerFactory.getLogger(PhysicalCassandraConnection.class);
     ...
     */
    public PhysicalCassandraConnection(Properties props) throws SQLException
    {
    ...
    {
        checkNotClosed();
        CassandraStatement statement = new PhysicalCassandraStatement(this);
    ...
    public CassandraStatement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException
    {
        ...
        CassandraStatement statement = new PhysicalCassandraStatement(this, null, resultSetType, resultSetConcurrency, resultSetHoldability);
        statements.add(statement);
        return statement;
    }
    ...
    public PhysicalCassandraPreparedStatement prepareStatement(String cql) throws SQLException
    {
        checkNotClosed();        
        
        try
        {
        	PhysicalCassandraPreparedStatement statement = new PhysicalCassandraPreparedStatement(this, cql, prepare(cql));
            statements.add(statement);
            return statement;
        }
        catch (InvalidRequestException e)
