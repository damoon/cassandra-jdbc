...
public class PhysicalCassandraDataSource implements CassandraDataSource, ConnectionPoolDataSource
{
    ...
    public PhysicalCassandraDataSource(String host, int port, String keyspace, String user, String password, String version)
    {
    ...
    public PhysicalCassandraConnection getConnection() throws SQLException
    {
        return getConnection(null, null);
    }

    public PhysicalCassandraConnection getConnection(String user, String password) throws SQLException
    {
        ...
        return (PhysicalCassandraConnection) DriverManager.getConnection(url, props);
    }
